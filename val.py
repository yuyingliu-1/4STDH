...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default= '/mnt/cd43550d-ff7b-4058-a185-a6b1f0bd96ea/dec/runs/traino/exp3/weights/best.pt', help='model.pt path(s)')
...
# python val.py --data data/mask_data.yaml --weights runs/train/exp36/weights/best.pt --img 640
