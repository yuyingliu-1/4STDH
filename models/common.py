...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='/mnt/cd43550d-ff7b-4058-a185-a6b1f0bd96ea/dec/runs/trainfd/exp10/weights/best.pt', device=None, dnn=True):
        # Usage:
        #   PyTorch:      weights = *.pt
...
class DecoupledHead(nn.Module):
    def __init__(self, ch=256, nc=2, anchors=()):
        super().__init__()
