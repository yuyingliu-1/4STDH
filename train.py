...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolov5kan.yaml', help='model.yaml path')
    ...
    parser.add_argument('--noval', action='store_true', help='only validate final epoch',default=True)
    ...
    parser.add_argument('--project', default=ROOT / 'runs/trainkan', help='save to project/name')
